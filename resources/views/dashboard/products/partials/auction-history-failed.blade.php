<table id="example-auction-history-failed" class="display table table-bordered" style = "width: 100%; padding:20px">
    <thead>
        <tr>
            <th>S.N</th>
            <th>Product Name</th>
    ...
    <tbody>
        @foreach($products["old_auction_no_bids"] as $key => $product)
        <tr>
            <td>{{ $key + 1 }}</td>
            <td>{{ $product->name }}</td>
