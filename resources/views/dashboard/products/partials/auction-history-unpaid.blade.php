<table id="example-auction-history-unpaid" class="display table table-bordered" style = "width: 100%; padding:20px">
    <thead>
        <tr>
            <th>S.N</th>
            <th>Product Name</th>
    ...
    <tbody>
        @foreach($products["old_unpaid_auctions"] as $key => $product)
        <tr>
            <td>{{ $key + 1 }}</td>
            <td>{{ $product->name }}</td>
